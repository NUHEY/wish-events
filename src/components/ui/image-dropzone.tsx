    ...
    >
      {value ? (
        <>
          ...
          <img src={value} alt="アップロード画像のプレビュー" className="absolute inset-0 h-full w-full object-contain" />
        ...
        <>
          ...
          <p className="mt-2 text-[11px] text-muted-foreground">JPG・PNG・WebP／推奨 4:3 または 1:1／10MB以下</p>
