...
function RouteShape({ pathname }: { pathname: string }) {
  ...
  if (pathname.startsWith("/talks/")) return <div className={base}><div className="flex items-center gap-3 border-b border-border pb-3"><Bone className="h-10 w-10 rounded-full" /><div className="flex-1"><Bone className="h-4 w-36" /><Bone className="mt-2 h-3 w-20" /></div></div><div className="flex flex-1 flex-col justify-end gap-2 pb-3"><Bone className="h-14 w-2/3 self-start rounded-[20px]" /><Bone className="h-10 w-1/2 self-end rounded-[20px]" /><Bone className="h-20 w-3/4 self-start rounded-[20px]" /></div><Bone className="h-12 w-full rounded-[24px]" /></div>;
  ...
  if (pathname.startsWith("/dashboard")) return <div className={base}><div className="grid grid-cols-4 gap-2">{Array.from({ length: 8 }).map((_, i) => <Bone key={i} className="h-24" />)}</div><div className="grid grid-cols-3 gap-3"><Bone className="h-24" /><Bone className="h-24" /><Bone className="h-24" /></div>{Array.from({ length: 3 }).map((_, i) => <Bone key={i} className="h-20 w-full" />)}</div>;
